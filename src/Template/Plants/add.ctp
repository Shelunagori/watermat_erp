        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject"><?= __('Add Plant') ?></span>
                </div>
            </div>
            <div class="portlet-body">
                <?= $this->Form->create($plant,['autocomplete'=>'off','type'=>'file']) ?>
                    <div class="form-body">
                        <div class="row">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <?= $this->Form->label('start_date', null, ['class'=>'control-label']) ?>
                                    <div class="input-icon right">
                                        <i class="fa fa-calendar"></i>
                                        <?= $this->Form->control('start_date', ['label'=>false,'class'=>'form-control date-picker','data-date-format'=>'dd-M-yyyy','required','type'=>'text']); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <tbody>
                <tr class="main_tr">
                    ...
                    <td>
                        ...
                        <?php echo $this->Form->hidden('godown_id', ['class'=>'godown_id','value'=>'']);?>
...
$(document).ready(function(){
    ...
    function rename_rows()
    {
        ...
        $('#main_tbody').find('.main_tr').each(function(){
            ...
            $(this).find('select.product_id').attr({name:'accounting_entries['+i+'][product_id]',id: ''}).select2();
            $(this).find('.quantity').attr({name:'accounting_entries['+i+'][quantity]',id: ''});
            $(this).find('.status').attr({name:'accounting_entries['+i+'][status]',id: ''});
            $(this).find('.refer_to').attr({name:'accounting_entries['+i+'][refer_to]',id: ''});
            $(this).find('.transaction_date').attr({name:'accounting_entries['+i+'][transaction_date]',id: ''});
            $(this).find('.godown_id').attr({name:'accounting_entries['+i+'][godown_id]',id: ''});
            $(this).find('select.vendor_id').attr({name:'accounting_entries['+i+'][vendor_id]',id: ''}).select2();
        });
    }
