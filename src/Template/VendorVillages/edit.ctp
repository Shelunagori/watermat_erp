        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject"><?= __('Edit Vendor Village') ?></span>
                </div>
            </div>
            <div class="portlet-body">
                <?= $this->Form->create($vendorVillage,['autocomplete'=>'off','type'=>'file']) ?>
                    <div class="form-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <?= $this->Form->label('vendor_id', null, ['class'=>'control-label']) ?>
                                    <?= $this->Form->control('vendor_id', ['empty'=>'--Select--','label'=>false,'class'=>'form-control select2me input-sm','options' => $vendors]); ?>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
