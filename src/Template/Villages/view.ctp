...
<div class="container-fluid">
    <table>
        ...
        <tr>
            ...
            <th colspan="2">DATE OF PARAMETER SURVEY: </th>
        </tr>    
        <tr>
            <td width="5%">18</td>
            <td width="40%">Borewell Availability</td>
            <td class="checkbox">
                <input type="checkbox" name="C1" value="C1" <?= $village->site_work->site_selection->borewell_available =='Yes' ? 'checked="checked"' : '' ?>> <big>Yes</big>
                <input type="checkbox" name="C2" value="C2" <?= $village->site_work->site_selection->borewell_available=='No' ? 'checked="checked"' : '' ?>> <big>No</big>
            </td>
        ...
        <tr>
            ...
            <td class="checkbox">
                <input type="checkbox" name="C3" value="C3"> <big>Yes</big>
                <input type="checkbox" name="C4" value="C4"> <big>No</big>
            </td>
        ...
        <tr>
            ...
            <td class="checkbox">
                <input type="checkbox" name="C5" value="C5"> <big>Yes</big>
                <input type="checkbox" name="C6" value="C6"> <big>No</big>
            </td>
            <td>Distance From Site: </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="vertical-align: bottom;" colspan="2" height="80px">(Name, Signature & Stamp of Concerned JEN / AEN / XEN)</td>
            <td style="vertical-align: bottom;" colspan="2" height="80px">(Name, Signature of Surveyor, WTPL)</td>
        </tr>    
    </table>
