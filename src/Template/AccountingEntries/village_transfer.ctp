        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject"><?= __('Transfer To Village') ?></span>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?= $this->Form->control('village_id', ['empty'=>false,'label'=>false,'class'=>'form-control select2me input-sm','options' => $villages,'required']); ?>
                                            <?= $this->Form->hidden('godown_id', ['label'=>false,'id'=>'godown-id','value'=>$godown_id]); ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
