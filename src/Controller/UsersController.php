...
class UsersController extends AppController
{
    ...
    {
		//pr($this->session->read('project_id')); exit;
    }
    ...
    public function selectProject()
    {
        ...
        if ($this->request->is('post')) {
			...
			$projectsDetail = $this->Users->Projects->find()->where(['id' =>$this->request->getData('project_id')])->first();
			$this->session->write('project_name',$projectsDetail->name);
