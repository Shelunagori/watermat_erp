...
/**
 * SubGodownRequestProductsFixture
 *
 */
class SubGodownRequestProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sub_godown_request_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'om_quantity' => 1.5,
                'created_by' => 1,
                'created_on' => 1553838887,
                'edited_by' => 1,
                'edited_on' => 1553838887,
                'is_deleted' => 1
            ],
        ];
        parent::init();
