...
/**
 * SubGodownRequestsFixture
 *
 */
class SubGodownRequestsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'godown_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'status' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => 'pending', 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_by' => 1,
                'created_on' => 1553838859,
                'edited_by' => 1,
                'edited_on' => 1553838859,
                'is_deleted' => 1
            ],
        ];
        parent::init();
