 ...
 *
 */
class OmSchedulesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'visit_date' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'visited_on' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'is_complete' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
        'is_verify' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'visited_on' => '2019-03-12',
                'is_complete' => 1,
                'is_verify' => 1,
                'created_by' => 1,
                'created_on' => 1552386748,
                'edited_by' => 1,
                'edited_on' => 1552386748,
                'is_deleted' => 1
            ],
        ];
        parent::init();
