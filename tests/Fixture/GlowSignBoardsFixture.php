...
/**
 * GlowSignBoardsFixture
 *
 */
class GlowSignBoardsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_received' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_by' => 1,
                'created_on' => 1549883671,
                'edited_by' => 1,
                'edited_on' => 1549883671,
                'is_deleted' => 1
            ],
        ];
        parent::init();
