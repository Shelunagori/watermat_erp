...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'warranty_days' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_on' => 1552129463,
                'created_by' => 1,
                'edited_on' => 1552129463,
                'edited_by' => 1,
                'is_deleted' => 1
            ],
        ];
