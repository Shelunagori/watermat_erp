...
/**
 * EmployeeVillagesFixture
 *
 */
class EmployeeVillagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'designation' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'village_id' => 1,
                'created_by' => 1,
                'created_on' => 1549340619,
                'edited_by' => 1,
                'edited_on' => 1549340619,
                'is_deleted' => 1
            ],
        ];
        parent::init();
