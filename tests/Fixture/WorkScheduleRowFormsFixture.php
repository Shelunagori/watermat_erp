...
/**
 * WorkScheduleRowFormsFixture
 *
 */
class WorkScheduleRowFormsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_complete' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_complete' => 1,
                'created_by' => 1,
                'created_on' => 1549695317,
                'edited_by' => 1,
                'edited_on' => 1549695317
            ],
        ];
        parent::init();
    }
