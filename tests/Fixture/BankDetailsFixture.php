...
class BankDetailsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'account_no' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'ifsc_code' => ['type' => 'string', 'length' => 11, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_by' => 1,
                'created_on' => 1548738955,
                'edited_by' => 1,
                'edited_on' => 1548738955,
                'is_deleted' => 1
            ],
        ];
        parent::init();
