...
/**
 * VillageRequestProductsFixture
 *
 */
class VillageRequestProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'village_request_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'product_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'quantity' => ['type' => 'decimal', 'length' => 15, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'om_quantity' => ['type' => 'decimal', 'length' => 15, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'village_request_id' => 1,
                'product_id' => 1,
                'quantity' => 1.5,
                'om_quantity' => 1.5,
                'created_by' => 1,
                'created_on' => 1552389384,
                'edited_by' => 1,
                'edited_on' => 1552389384,
                'is_deleted' => 1
            ],
        ];
        parent::init();
