...
/**
 * VendorVillagesFixture
 *
 */
class VendorVillagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'vendor_designation_id' => ['type' => 'unique', 'columns' => ['vendor_designation_id', 'vendor_id', 'village_id', 'is_deleted'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'village_id' => 1,
                'created_by' => 1,
                'created_on' => 1549340674,
                'edited_by' => 1,
                'edited_on' => 1549340674,
                'is_deleted' => 1
            ],
        ];
        parent::init();
