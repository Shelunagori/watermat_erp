...
class WorkSchedulesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'days' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'model' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_by' => 1,
                'created_on' => 1549615833,
                'edited_by' => 1,
                'edited_on' => 1549615833,
                'is_deleted' => 1
            ],
        ];
        parent::init();
